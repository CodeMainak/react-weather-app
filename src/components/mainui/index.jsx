...
export default class MainUi extends React.Component {
    ...
    render() {
        return <div className="view-container">
            <div className="title"><h2>WEATHER APP</h2></div>
            <div className="search-section">
                ...
                <div className="button-view center">
                    <button className="middle waves-effect  btn small indigo " onClick={this.getWeather.bind(this)}>Get Weather</button>
                </div>
            </div>
            {
                this.state.hideData ?
                    <div className="two-days">
                        <Tabs>
                            ...
                            <div className="data-ui">
                                <TabPanel>
                                    {this.state.today.map((info, index) => {
                                        return <ThreeHourlyInfo key={index} passedData={info} />
                                    })}
                                </TabPanel>
                                <TabPanel >
                                    {this.state.tomorrow.map((info, index) => {
                                        return <ThreeHourlyInfo key={index} passedData={info} />
                                    })}
                                </TabPanel>
                            </div>
